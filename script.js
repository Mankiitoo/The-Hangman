...
let listaDePalabras = ['ORACLE','LATAM','ALURA','SOFTWARE','HARDWARE','JAVA','PROGRAMACION', 'HANGMAN'];
...
window.addEventListener("keydown", (element) => {
  if (flag && validarLetra(element.key) && contador < 9) {
    ...
    dibujarPerdedor();
    swal("¡Has perdido!", `La palabra era "${palabraJuego.join("")}", Clickea a nuevo juego si quieres volver a jugar.`, "info");
  } else if (esGanador) {
